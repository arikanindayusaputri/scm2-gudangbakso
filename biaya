    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Biaya Produksi</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">
                                ...
                                <a href="cetakbiaya.php" class="btn btn-success">Cetak Data</a> 
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$idt;?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?=$idbiaya;?>">
                                                   Edit
                                                 </button>
                                                <!-- <input type="hidden" name="idygmaudihapus" value="<?=$id;?>"> -->
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idbiaya;?>">
                                                  Delete
                                                </button>
                                            </td>
                                        </tr>
                                        <!-- Edit Modal -->
                                        <div class="modal fade" id="edit<?=$idbiaya;?>">
                                                ...
                                                <!-- Hapus Modal -->
                                            <div class="modal fade" id="delete<?=$idbiaya;?>">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <br>
                <select name="idte" class="form-control">
                    <?php
                ...
                <button type="submit" class="btn btn-primary" name="addbiaya">submit</button>
            </div>
            </form>
