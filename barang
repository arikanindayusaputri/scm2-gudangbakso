...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                                            ...
                                            <div class="modal fade" id="edit<?=$idb;?>">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="text" name="id_barang" value="<?=$idb;?>" class="form-control"required><br>
                                                        <input type="text" name="id_kategori" value="<?=$idk;?>" class="form-control"required><br>
                                                        <input type="text" name="nama_barang" value="<?=$namab;?>" class="form-control"required><br>
        ...
        <div class="modal-dialog">
            ...
            <form method="post">
            <div class="modal-body">
                <input type="text" name="id_barang" placeholder="Id Barang" class="form-control"><br>
                <input type="text" name="id_kategori" placeholder="Id Kategori Barang" class="form-control"><br>
                <input type="text" name="nama_barang" placeholder="Nama Barang" class="form-control"><br>
